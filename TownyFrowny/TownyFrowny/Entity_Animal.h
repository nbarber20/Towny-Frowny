...
public:
	Entity_Animal(wchar_t EntityID, sf::Vector2i spritePos, int volume, wchar_t MeatID, TaskManager* manager,std::vector<TargetedHumanBehaviors> TargetedBehaviors); 	
	void Tick() override;
